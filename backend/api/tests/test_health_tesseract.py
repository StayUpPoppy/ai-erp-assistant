...
def test_health_includes_tesseract_probe() -> None:
    ...
    assert isinstance(h.rapidocr_importable, bool)
    assert isinstance(h.rapidocr_initializable, bool)
    assert isinstance(h.rapidocr_init_status, str)
    assert isinstance(h.rapidocr_version, str)
    assert isinstance(h.rapidocr_intra_op_threads, int)
    ...
    assert isinstance(h.qwen_vision_extract_enabled, bool)
    assert isinstance(h.qwen_vision_force_all, bool)
    assert isinstance(h.qwen_vision_enable_thinking, bool)
    assert isinstance(h.qwen_vision_model, str)
    assert isinstance(h.qwen_vision_base_url, str)
    assert isinstance(h.qwen_vision_api_key_configured, bool)
    assert isinstance(h.qwen_vision_timeout_seconds, float)
    assert isinstance(h.qwen_vision_max_pdf_pages, int)
    assert isinstance(h.qwen_vision_render_dpi, int)
    ...
    assert isinstance(h.customer_own_company_keywords_configured, bool)
    assert isinstance(h.customer_own_company_keywords_valid, bool)
    assert isinstance(h.customer_own_company_keywords_count, int)
    assert isinstance(h.llm_extract_enable_thinking, bool)
