...
QWEN_VISION_PROMPT_VERSION = "qwen-vision-order-preview-v4-currency"
ENGLISH_QWEN_VISION_PROMPT_VERSION = f"qwen-vision-order-preview-{ENGLISH_PO_ROUTE_VERSION}-currency-v1"
...
def _apply_purchase_order(
    ...
    *,
    ...
    currency_resolution = resolve_order_currency(local_text or "", purchase_order.currency)
