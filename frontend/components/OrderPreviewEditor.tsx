...
const DETAIL_COLUMNS: Array<{
  ...
  { key: "price", label: "不含税单价", type: "number", required: true },
  { key: "taxPrice", label: "含税单价", type: "number", required: true },
  { key: "amount", label: "不含税金额", type: "number", required: true },
  { key: "allAmount", label: "含税金额", type: "number", required: true },
  { key: "tax", label: "税率", type: "number", required: true },
